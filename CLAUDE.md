...
8. **Trace File Generation** (halloween_roaster.py:274-289)
...
- Must manually manage storage and backup
- To backup traces, copy the `traces/` folder to another location

**Implementation:**
- Trace generation: halloween_roaster.py:274-289
